...
const Home = () => {
  const COMMON_SPAN_CLASS = "uppercase font-bold text-red-label";
    ...
    <section className="min-h-full flex items-center">
      <div className="w-full grid md:grid-cols-2 gap-15 items-center">
        ...
        <div className="relative flex justify-center">
          <div className="absolute -top-6 right-10 bg-red-label text-white px-4 py-2 rounded-full text-sm shadow-lg">
            Live Editor
          </div>
